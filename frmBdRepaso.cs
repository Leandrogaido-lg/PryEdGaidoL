...
namespace PryEdGaidoL
{
    public partial class frmBdRepaso : Form
    {
        ...
        private void frmBdRepaso_Load(object sender, EventArgs e)
        {
            ...
            cmbEleccion.Items.Add("Todos los libros ordenados por título");
            cmbEleccion.Items.Add("Libros con su autor");
            cmbEleccion.Items.Add("Libros por país");
            cmbEleccion.Items.Add("Libros por idioma");
            cmbEleccion.Items.Add("Todos los autores");
        }

        private void btnListar_Click(object sender, EventArgs e)
        {
            if (cmbEleccion.SelectedIndex == -1)
            {
            ...
            objBaseDatos.Listar(dgvListar, sql);
        }
        private void cmbEleccion_SelectedIndexChanged(object sender, EventArgs e)
        {
            btnListar.Enabled = cmbEleccion.SelectedIndex != -1;
        }
    }
}
